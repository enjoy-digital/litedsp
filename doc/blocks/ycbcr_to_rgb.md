...
| `n_out` | `3` | int |  |
| `coefficients` | `[4769, 0, 6537, 4769, -1605, -3330, 4769, 8263, 0]` | list | Coefficient list (signed integers, quantized via litedsp.filter.design). |
| `in_offsets` | `(16, 128, 128)` | list |  |
