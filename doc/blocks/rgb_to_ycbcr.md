...
| `n_out` | `3` | int |  |
| `coefficients` | `[1052, 2065, 401, -607, -1192, 1799, 1799, -1506, -293]` | list | Coefficient list (signed integers, quantized via litedsp.filter.design). |
| `in_offsets` | `(0, 0, 0)` | list |  |
| `out_offsets` | `(16, 128, 128)` | list |  |
| `coeff_width` | `16` | int |  |
| `coeff_frac` | `12` | int |  |
