...
| `kernel_size` | `3` | int |  |
| `coefficients` | `[1, 2, 1, 2, 4, 2, 1, 2, 1]` | list | Coefficient list (signed integers, quantized via litedsp.filter.design). |
| `coeff_width` | `10` | int |  |
| `shift` | `4` | int | Output rescale shift (defaults to data_width - 1). |
| `offset` | `0` | int |  |
| `width` | `64` | int |  |
| `max_width` | — | none |  |
...
### `shift_offset` (read-write, 17 bits, reset `0x4`)

| Bits | Field | Reset | Description |
|---|---|---|---|
| `[3:0]` | `shift` | `4` | Right shift of the sum. |
