...
| `kernel_size` | `3` | int |  |
| `coefficients` | `[0, 1, 0, 1, -4, 1, 0, 1, 0]` | list | Coefficient list (signed integers, quantized via litedsp.filter.design). |
| `coeff_width` | `10` | int |  |
...
### `shift_offset` (read-write, 17 bits, reset `0x8000`)

| Bits | Field | Reset | Description |
|---|---|---|---|
| `[3:0]` | `shift` | `0` | Right shift of the sum. |
| `[16:8]` | `offset` | `128` | Signed offset added after the shift. |
