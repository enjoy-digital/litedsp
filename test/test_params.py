...
SPECIFIC = [
    ...
    ("os_cfar",         {"n_train": 9}),
    ("os_cfar",         {"rank": 8}),
    ("clutter_map",     {"avg_shift": 0}),
    ("clutter_map",     {"n_range_bins": 4, "n_doppler_bins": 1}),
    ...
    ("pixel_lut",       {"gamma": 0}),
    ("pixel_stats",     {"zones": 3}),
    ("pixel_histogram", {"bins_log2": 9}),
    ("alpha_blend",     {"alpha": 300}),
    ("box_overlay",     {"thickness": 16}),
    ("color_matrix",    {"coefficients": [1]*8}),
    ("debayer",         {"pattern": "rgbg"}),
    ("downscaler",      {"decimation": 3}),
    ("crop",            {"roi_width": 0}),
    ("rank_filter",     {"rank": 9}),
    ("threshold",       {"high": 100, "low": 120}),
    ("pixel_gain",      {"gain_frac": 11}),
    ("kernel_2d",       {"shift": 16}),
