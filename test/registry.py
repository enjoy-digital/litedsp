...
VSPEC = {
    ...
    "line_encoder":       _v("line_encode_model", latency=1, cosim=True),
    ...
    "sobel":              _v("sobel_model", latency=71, cosim=True),
    "rank_filter":        _v("rank_filter_model", latency=72, cosim=True),
    "erode":              _v("rank_filter_model", latency=72, cosim=True),
    "dilate":             _v("rank_filter_model", latency=72, cosim=True),
    "threshold":          _v("threshold_model", latency=1, cosim=True),
    "pixel_gain":         _v("pixel_gain_model", latency=2, cosim=True),
    "pixel_lut":          _v("pixel_lut_model", latency=1, cosim=True),
    "gamma":              _v("pixel_lut_model", latency=1, cosim=True),
    "color_matrix":       _v("color_matrix_model", latency=3, cosim=True),
    "rgb_to_ycbcr":       _v("color_matrix_model", latency=3, cosim=True),
    "ycbcr_to_rgb":       _v("color_matrix_model", latency=3, cosim=True),
    "rgb_to_gray":        _v("color_matrix_model", latency=3, cosim=True),
    "debayer":            _v("debayer_model", latency=70, cosim=True),
    "downscaler":         _v("downscaler_model", latency=2, rate=None, cosim=True),
    "crop":               _v("crop_model", latency=1, rate=None, cosim=True),
    "pixel_stats":        _v("pixel_stats_model", latency=0),
    "pixel_histogram":    _v("histogram_model", latency="variable", rate=None, cosim=True),
    "alpha_blend":        _v("alpha_blend_model", latency=1, cosim=True),
    "mask_blend":         _v("alpha_blend_model", latency=1, cosim=True),
    "box_overlay":        _v("box_overlay_model", latency=1, cosim=True),
