...
VARIABLE_LATENCY = {
    "doppler", "ca_cfar", "cfar_2d", "os_cfar", "peak_extractor", "target_list",
    "alpha_beta_tracker", "kalman_tracker", "pixel_histogram", "hamming_encoder", "hamming_decoder",
    "hdlc_framer", "hdlc_deframer", "bch_encoder", "bch_decoder",
    "corner_turn",
    "bit_reverse",
