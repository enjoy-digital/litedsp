...
def block_page(spec, budgets):
    ...
    out.append("")
    if b:
        out.append("| Device | LUT | FF | BRAM | DSP | Fmax (MHz) |")
        out.append("|---|---|---|---|---|---|")
        ...
        out.append("")
        out.append("Measured by the `impl/` flows at the registry configuration; regenerated by "
                   "`python3 impl/report.py` (budget-gated in CI).")
    else:
