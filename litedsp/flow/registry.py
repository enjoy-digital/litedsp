...
ENTRIES = [
    ...
    ("kernel_2d", LiteDSPKernel2D,
     dict(data_width=8, width=64, n_channels=1, kernel_size=3,
          coefficients=kernel_preset("identity")[0], shift=kernel_preset("identity")[1],
          offset=kernel_preset("identity")[2]),
     "image", "2-D kernel (3x3)", {"border": ["replicate", "mirror", "zero"],
                                   "n_channels": [1, 3]}),
    ("kernel_5x5", LiteDSPKernel2D,
     dict(data_width=8, width=64, n_channels=1, kernel_size=5,
          coefficients=kernel_preset("gaussian5")[0], shift=kernel_preset("gaussian5")[1],
          offset=kernel_preset("gaussian5")[2]),
     "image", "2-D kernel (5x5)", {"border": ["replicate", "mirror", "zero"],
                                   "n_channels": [1, 3]}),
    ("gaussian_blur", LiteDSPKernel2D,
     dict(data_width=8, width=64, n_channels=1, kernel_size=3,
          coefficients=kernel_preset("gaussian3")[0], shift=kernel_preset("gaussian3")[1],
          offset=kernel_preset("gaussian3")[2]),
     "image", "Gaussian blur", {"border": ["replicate", "mirror", "zero"], "n_channels": [1, 3]}),
    ("sharpen", LiteDSPKernel2D,
     dict(data_width=8, width=64, n_channels=1, kernel_size=3,
          coefficients=kernel_preset("sharpen")[0], shift=kernel_preset("sharpen")[1],
          offset=kernel_preset("sharpen")[2]),
     "image", "Sharpen", {"border": ["replicate", "mirror", "zero"], "n_channels": [1, 3]}),
    ("laplacian", LiteDSPKernel2D,
     dict(data_width=8, width=64, n_channels=1, kernel_size=3,
          coefficients=kernel_preset("laplacian")[0], shift=kernel_preset("laplacian")[1],
          offset=kernel_preset("laplacian")[2]),
     "image", "Laplacian", {"border": ["replicate", "mirror", "zero"], "n_channels": [1, 3]}),
    ...
    ("color_matrix", LiteDSPColorMatrix,
     dict(data_width=8, n_out=3, coefficients=color_preset("identity")[0],
          in_offsets=color_preset("identity")[1], out_offsets=color_preset("identity")[2]),
     "image", "Colour matrix", {}),
    ("rgb_to_ycbcr", LiteDSPColorMatrix,
     dict(data_width=8, n_out=3, coefficients=color_preset("rgb_to_ycbcr_601")[0],
          in_offsets=color_preset("rgb_to_ycbcr_601")[1],
          out_offsets=color_preset("rgb_to_ycbcr_601")[2]),
     "image", "RGB to YCbCr (601)", {}),
    ("ycbcr_to_rgb", LiteDSPColorMatrix,
     dict(data_width=8, n_out=3, coefficients=color_preset("ycbcr_to_rgb_601")[0],
          in_offsets=color_preset("ycbcr_to_rgb_601")[1],
          out_offsets=color_preset("ycbcr_to_rgb_601")[2]),
     "image", "YCbCr to RGB (601)", {}),
    ("rgb_to_gray", LiteDSPColorMatrix,
     dict(data_width=8, n_out=1, coefficients=color_preset("rgb_to_gray_601")[0],
          in_offsets=color_preset("rgb_to_gray_601")[1],
          out_offsets=color_preset("rgb_to_gray_601")[2]),
     "image", "RGB to grey (601)", {}),
